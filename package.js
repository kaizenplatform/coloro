...
var appName = argv.name || argv.n || require('./package.json').name;
...
DEFAULT_OPTS['app-version'] = require('./package.json').version
...
function log(plat, arch) {
  return function(err, filepath) {
    if (err) return console.error(err);
    console.log(plat + '-' + arch + ' finished! Check the release/ directory.');
  };
}
